!function() {
        ...
        IDBStore.prototype = {
            ...
            openDB: function() {
                ...
                openRequest.onerror = function(error) {
                    ...
                    this.onError(gotVersionErr ? new Error("The version number provided is lower than the existing one.") : error);
    ...
    angular.module("angular-growl", []), angular.module("angular-growl").directive("growl", [ "$rootScope", function($rootScope) {
            ...
            var disableRepairCommand = !0, text = {
                ...
                function generateConfigDropdown(result, handler) {
                    result.configDropdown = [], result.up && result.configDropdown.push({
                        ...
                        index: result.index,
                        handler: handler
                    }), result.configDropdown.push(result["in"] ? {
                        text: text.out,
                        id: result.id,
                        cmd: "out",
                        index: result.index,
        ...
        define("helpers/pool-helpers", [ "lodash" ], function(_) {
            ...
            function errorOnPoolSave($scope) {
                return function(resp) {
            ...
            Configurer.init = function(object, config) {
                function RestangularResource(config, $http, url, configurer) {
                    ...
                    return _.each(_.keys(configurer), function(key) {
                        ...
                        _.isEmpty(value.params) && delete value.params, resource[key] = config.isSafe(value.method) ? function() {
